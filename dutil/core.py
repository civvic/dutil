...
# %% auto #0
__all__ = ['setup_dialog', 'solveit_version', 'in_dialog', 'get_caller_globals', 'waitpred', 'next_dup', 'next_filename',
           'gen_id', 'at_', 'setup_ns', 'info', 'add_info', 'summarize', 'get_output', 'get_tag', 'link_msg',
           'get_tool_names', 'show_tool_names', 'add_tools_card', 'ctxusage', 'empty_dialog_nb', 'find_symbol_msg',
           'importdlg']
