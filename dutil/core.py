...
# %% auto #0
__all__ = ['setup_dialog', 'solveit_version', 'in_dialog', 'get_caller_globals', 'get_tag', 'link_msg', 'waitpred', 'waitpreda',
           'next_dup', 'next_filename', 'gen_id', 'at_', 'setup_ns', 'info', 'add_info', 'summarize', 'get_output',
           'format_output', 'get_tool_names', 'show_tool_names', 'add_tools_card', 'dialog_link', 'ctxusage',
           'empty_dialog_nb', 'find_symbol_msg', 'importdlg']
