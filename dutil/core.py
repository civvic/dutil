...
# %% auto 0
__all__ = ['code_id', 'setup_dialog', 'solveit_version', 'in_dialog', 'get_caller_globals', 'gen_id', 'at_', 'get_tool_names',
           'add_tools_card', 'get_output', 'link_msg', 'setup_ns', 'info', 'add_info', 'summarize']
