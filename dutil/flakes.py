...
# %% auto #0
__all__ = ['IMPORTS', 'VARS', 'ListReporter', 'is_exported', 'get_tagged_source', 'check_source_flakes', 'check_flakes',
           'add_flakes', 'show_flakes']

# %% ../nbs/05_flakes.ipynb #097e61a0
import re
...
# %% ../nbs/05_flakes.ipynb #082b8d5b
_exports = {'exporti', 'exports', 'export'}

# %% ../nbs/05_flakes.ipynb #542befaf
def is_exported(msg):
    return msg.is_exported or bool(
        extract_directives(FC.AttrDict(source=msg.content), remove=False).keys() & _exports)

# %% ../nbs/05_flakes.ipynb #0af65b34
